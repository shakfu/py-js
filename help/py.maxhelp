...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 228.0, 283.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 228.0, 327.0, 137.0, 22.0 ],
									"saved_object_attributes" : 									{
										"filename" : "array-math-bench.js",
										"parameter_enable" : 0
									}
,
									"text" : "js array-math-bench.js"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 17.0, 39.0, 596.0, 147.0 ],
									"text" : "The following test replicates the exact performance test which is in the v8.maxhelp.\n\nOn an M1 Macbook Air the results are aproximately in order of fastest:\n\n1. v8 in 27 ms (pre-jit, subsequent runs reach 9 ms)\n\n2. py in 160 ms\n\n3. js in 170 ms "
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Comparing Performance with js and v8 engines"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 91.0, 244.0, 120.0, 22.0 ],
									"presentation" : 1,
									"presentation_linecount" : 3,
									"presentation_rect" : [ 670.0, 410.0, 76.0, 49.0 ],
									"text" : "load test_api_perf.py"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 17.0, 244.0, 61.0, 22.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 402.0, 483.0, 61.0, 22.0 ],
									"text" : "import api"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 17.0, 327.0, 47.0, 22.0 ],
									"text" : "s to_py"
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 221.0, 700.0, 24.0, 24.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 274.0, 700.0, 24.0, 24.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 17.0, 612.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 17.0, 656.0, 29.5, 22.0 ],
									"text" : "set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 156.0, 656.0, 55.0, 22.0 ],
									"text" : "r to_msg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 221.0, 656.0, 47.0, 22.0 ],
									"text" : "r to_err"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 274.0, 656.0, 45.0, 22.0 ],
									"text" : "r to_ok"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 17.0, 702.0, 158.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 91.0, 283.0, 83.0, 22.0 ],
									"text" : "benchmark1()"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 23.0, 615.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 162.0, 663.0, 55.0, 22.0 ],
									"text" : "r to_msg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 227.0, 663.0, 47.0, 22.0 ],
									"text" : "r to_err"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 280.0, 663.0, 45.0, 22.0 ],
									"text" : "r to_ok"
								}
...
, 							{
								"box" : 								{
									"autoload" : 0,
									"file" : "/Volumes/Minx/Users/sa/projects/py-js/examples/tests/test_api_perf.py",
									"id" : "obj-7",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 3,
