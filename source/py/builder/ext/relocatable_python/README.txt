This is Greg Neagle's excellent tool to make a relocatable Python framework.

His original code can be downloaded from https://github.com/gregneagle/relocatable-python

The rest of this README is as from the original:
