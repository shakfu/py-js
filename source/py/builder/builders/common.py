...
class CommonBuilder(Builder):
    ...
    def rm_ext(self, *args):
        for arg in args:
            ...
            self.cmd(
                f"rm -rf {self.lib}/lib-dynload/{arg}.cpython-${self.py_ver}-darwin.so"
            )
    ...
    def zip_python_library(self):
        ...
        self.cmd(
            f"python -m zipfile -c {self.prefix}/lib/python{self.py_ver}.zip {self.lib}/*"
        )
