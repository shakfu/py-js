...
/// @tparam T	         The type of integer to use for the determination.
/// @param a_value	 The value to test.
/// @see is_power_of_two
...
/// @param	input		The value to constrain.
/// @param	a_low_bound	The low bound for the range.
/// @param	a_high_bound	The high bound for the range.
...
/// @tparam			The data type of the number to be constrained.
/// @param	input		The value to constrain.
/// @param	low_bound	The low bound for the range.
/// @param	high_bound	The high bound for the range.
