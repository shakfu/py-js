/*
	...
	py.h - public domain - https://github.com/shakfu/py-js

	This is a single header python3 external object.

	It's supposed to be nested inside another external.

    If PY_IMPLEMENTATION is defined before including the header, it will
    activate the implementation, otherwise the implementation will
    not be inlcluded.
