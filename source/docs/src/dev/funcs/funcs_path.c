...
short path_getapppath(void); 		// Max.app
short path_getsupportpath(void);	// Max.app/../Resources/C74
short path_tempfolder(void);		// $HOME/Library/Application Support/Cycling '74/Max 8/Settings/temp64-Max
short path_desktopfolder(void);  	// $HOME/Desktop
short path_userdocfolder(void);  	// $HOME/Documents
short path_usermaxfolder(void);  	// HOME/Documents/Max 8
short path_getdefault(void); 		// $HOME/Downloads/projects/py-js/patchers
...
short path_resolvefile(char *name, C74_CONST short path, short *outpath); // pid -> name -> pid
