...
This builds all of the externals *except* for the networking variants, since they have some additional dependencies.

To build the networking externals you need a few more dependencies related to the lightweight networking [zeromq](https://zeromq.org) library:

```sh
brew install zmq czmq
```

Now you can build them via:
