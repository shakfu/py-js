...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.5, 110.0, 120.0, 22.0 ],
					"text" : "test_pyexternal_init()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 344.5, 77.0, 155.0, 22.0 ],
					"text" : "load test_api_pyexternal.py"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "\"u541001039 external is initialized\""
				}
...
, 			{
				"box" : 				{
					"autoload" : 0,
					"file" : "/Volumes/Minx/Users/sa/projects/py-js/examples/tests/test_api_pyexternal.py",
					"id" : "obj-1",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 3,
