...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.0, 488.0, 189.0, 21.0 ],
					"text" : "test_maxobject_isinstance_object()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.0, 339.0, 170.0, 21.0 ],
					"text" : "test_maxobject_add_attribute()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 485.0, 133.0, 159.0, 21.0 ],
					"text" : "test_maxobject_registration()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.0, 294.0, 50.0, 21.0 ],
					"text" : "set buf1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 487.0, 55.0, 189.0, 19.0 ],
					"text" : "then run test_maxobject_init()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 346.0, 166.0, 130.0, 21.0 ],
					"text" : "test_maxobject_query()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 133.0, 140.0, 21.0 ],
					"text" : "test_maxobject_refpage()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 105.0, 123.0, 21.0 ],
					"text" : "test_maxobject_help()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.0, 265.0, 175.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 485.0, 105.0, 145.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.0, 232.0, 158.0, 21.0 ],
					"text" : "test_maxobject_call_wclose()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 487.0, 199.0, 149.0, 21.0 ],
					"text" : "test_maxobject_call_open()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.0, 296.0, 133.0, 21.0 ],
					"text" : "test_maxobject_delete()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.0, 294.0, 43.0, 21.0 ],
					"text" : "set buf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 487.0, 166.0, 161.0, 21.0 ],
					"text" : "test_maxobject_call_replace()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 487.0, 76.0, 118.0, 21.0 ],
...
, 			{
				"box" : 				{
					"autoload" : 0,
					"file" : "/Volumes/Minx/Users/sa/projects/py-js/examples/tests/test_api_maxobject.py",
					"id" : "obj-20",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 13.0, 571.0, 24.0 ],
					"text" : "Demo of api.Maxobject"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 414.0, 272.0, 99.5, 272.0 ],
					"source" : [ "obj-27", 0 ]
				}
