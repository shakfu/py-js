...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 378.5, 361.0, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 379.5, 311.0, 91.0, 22.0 ],
					"text" : "test_next_box()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.5, 266.0, 163.0, 22.0 ],
					"text" : "test_box_object_getvalueof()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.5, 224.0, 162.0, 22.0 ],
					"text" : "test_box_object_setvalueof()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.5, 184.0, 105.0, 22.0 ],
					"text" : "test_named_box()"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 113.0, 54.0, 20.0 ],
					"text" : "myfloat"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 38.0, 143.0, 50.0, 22.0 ],
					"varname" : "myfloat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.5, 145.0, 124.0, 22.0 ],
					"text" : "test_pyexternal_box()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 344.5, 77.0, 119.0, 22.0 ],
					"text" : "load test_api_box.py"
				}
...
, 			{
				"box" : 				{
					"autoload" : 0,
					"file" : "/Volumes/Minx/Users/sa/projects/py-js/examples/tests/test_api_box.py",
					"id" : "obj-1",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 3,
