...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 153.0, 96.0, 22.0 ],
					"text" : "api.support_dir()"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 123.0, 109.0, 22.0 ],
					"text" : "api.resources_dir()"
				}
...
, 			{
				"box" : 				{
					"autoload" : 0,
					"file" : "/Volumes/Minx/Users/sa/projects/py-js/examples/tests/test_api_functions.py",
					"id" : "obj-1",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 3,
